...
Para esta planeación definimos en grupo cuanto sería el porcentaje de esfuerzo en cada una de tareas del ciclo, teniendo en cuenta tareas como documentación (Miscelánea), arreglo de bugs y capacitación.
...
Para el seguimiento del valor ganado dividimos el porcentaje de desarrollo de todos los requerimientos basado en el porcentaje definido en el punto "Estimación por requerimiento".
...
**Total time spent**||81h 36m|66h 47m